...
interface AdminInquiryCloseModalProps {
...
export default function AdminInquiryCloseModal({
  inquiry,
  isPending,
  onClose,
  onConfirm,
}: AdminInquiryCloseModalProps) {
    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-sm leading-6 text-muted">
          ...
          {" "}문의를 종료합니다. 종료 후에는 답변을 추가할 수 없습니다.
        </p>
