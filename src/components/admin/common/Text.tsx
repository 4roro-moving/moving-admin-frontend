...
const TEXT_VARIANT_STYLES = {
  ...
  "md-bold":
    "text-[length:var(--font-size-14)] leading-[var(--line-height-24)] font-bold",
  ...
  "lg-bold":
    "text-[length:var(--font-size-16)] leading-[var(--line-height-26)] font-bold",

  "2lg-regular":
    "text-[length:var(--font-size-18)] leading-[var(--line-height-26)] font-regular",
  "2lg-medium":
    "text-[length:var(--font-size-18)] leading-[var(--line-height-26)] font-medium",
  "2lg-semibold":
    "text-[length:var(--font-size-18)] leading-[var(--line-height-26)] font-semibold",
  "2lg-bold":
    "text-[length:var(--font-size-18)] leading-[var(--line-height-26)] font-bold",

  "xl-regular":
    "text-[length:var(--font-size-20)] leading-[var(--line-height-32)] font-regular",
  "xl-medium":
    "text-[length:var(--font-size-20)] leading-[var(--line-height-32)] font-medium",
  "xl-semibold":
    "text-[length:var(--font-size-20)] leading-[var(--line-height-32)] font-semibold",
  "xl-bold":
    "text-[length:var(--font-size-20)] leading-[var(--line-height-32)] font-bold",

  "2xl-regular":
    "text-[length:var(--font-size-24)] leading-[var(--line-height-32)] font-regular",
  "2xl-medium":
    "text-[length:var(--font-size-24)] leading-[var(--line-height-32)] font-medium",
  "2xl-semibold":
    "text-[length:var(--font-size-24)] leading-[var(--line-height-32)] font-semibold",
  "2xl-bold":
    "text-[length:var(--font-size-24)] leading-[var(--line-height-32)] font-bold",

  "3xl-semibold":
    "text-[length:var(--font-size-32)] leading-[var(--line-height-46)] font-semibold",
  "3xl-bold":
    "text-[length:var(--font-size-32)] leading-[var(--line-height-46)] font-bold",
  ...
  "rating-score":
    "text-[length:var(--font-size-40)] leading-[var(--line-height-48)] font-medium",
} as const;
...
const TEXT_VARIANT_STYLES_MD = {
  ...
  "md-bold":
    "md:text-[length:var(--font-size-14)] md:leading-[var(--line-height-24)] md:font-bold",
  ...
  "lg-bold":
    "md:text-[length:var(--font-size-16)] md:leading-[var(--line-height-26)] md:font-bold",
  ...
  "xl-bold":
    "md:text-[length:var(--font-size-20)] md:leading-[var(--line-height-32)] md:font-bold",
...
const TEXT_VARIANT_STYLES_XL = {
  ...
  "md-bold":
    "xl:text-[length:var(--font-size-14)] xl:leading-[var(--line-height-24)] xl:font-bold",
  ...
  "lg-bold":
    "xl:text-[length:var(--font-size-16)] xl:leading-[var(--line-height-26)] xl:font-bold",
  ...
  "xl-bold":
    "xl:text-[length:var(--font-size-20)] xl:leading-[var(--line-height-32)] xl:font-bold",
...
function isResponsiveTextVariant(
  variant: TextVariantProp,
): variant is ResponsiveTextVariant {
  return typeof variant === "object" && variant !== null && "base" in variant;
}

function isSemanticTextVariant(
  variant: TextVariantProp,
): variant is SemanticTextVariant {
...
function resolveTextVariant(
  variant: TextVariantProp,
): TextVariant | ResponsiveTextVariant {
...
export default function Text<T extends ElementType = "span">({
  ...
  return (
    <Component
      className={cn(getTextVariantClass(variant), className)}
      {...props}
    >
      {children}
    </Component>
